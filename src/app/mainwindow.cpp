...
namespace Mayo {
    ...
    void MainWindow::createCommands()
    {
        ...
        // "Convertor" commands  ← ADD THIS
        this->addCommand<CommandConvertor>();
    ...
    void MainWindow::createMenus()
    {
        ...
        { // Convertor  ← ADD THIS WHOLE BLOCK
            auto menu = m_ui->menuConvertor;
            fnAddAction(menu, CommandConvertor::Name);
        }
